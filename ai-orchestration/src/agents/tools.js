...
export const listFiles = tool(
    async({})=>{
        ...
        console.log("=========================================")
        const response = await axios.get("http://019e5008-52b2-75a8-83f9-1cf1310bd155.agent.localhost/list-files")
...
export const readFiles = tool(
    async ({files:[]})=>{
        ...
        const response = await axios.get("http://019e5008-52b2-75a8-83f9-1cf1310bd155.agent.localhost/read-files?files="+files.join(","))
        console.log("=========================================")
...
export const updateFiles = tool(
    async ({files})=>{
        ...
        console.log("=========================================")
        const response = await axios.patch("http://019e5008-52b2-75a8-83f9-1cf1310bd155.agent.localhost/update-files",{
            updates: files
        })
        console.log("=========================================")
